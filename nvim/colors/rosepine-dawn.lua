...
local groups = {
	...
	['@function.builtin'] = { fg = colors.pine },
	...
	LspReferenceRead = { bg = colors.highlight_hi },
	LspReferenceText = {},
	...
	BlinkCmpLabelDescription = { fg = colors.subtle, italic = true },
	...
	BlinkCmpKind = { fg = colors.subtle, bg = colors.base },
	BlinkCmpLabel = { fg = colors.text, bg = colors.base },
	BlinkCmpLabelMatch = { fg = colors.love, bg = colors.base },
	BlinkCmpMenuBorder = { fg = colors.highlight_hi, bg = colors.base },
	...
	BlinkCmpDocBorder = { fg = colors.highlight_hi, bg = colors.base },
	BlinkCmpSignatureHelp = { bg = colors.overlay },
	BlinkCmpSignatureHelpBorder = { fg = colors.highlight_hi, bg = colors.base },
	...
	DiffDelete = { fg = colors.love, bg = colors.base },
	DiffText = { fg = colors.base, bg = colors.gold, bold = true },
	DiffviewFolderSign = { fg = colors.pine },
	DiffviewNonText = { fg = colors.iris },
	...
	-- Links.
	HighlightUrl = { underline = true, fg = colors.love, sp = colors.neon_cyan },
}
