...
require('rose-pine').setup({
	highlight_groups = {
		...
		['@markup.heading.1.markdown'] = { bg = 'base', fg = 'love' },
		['@markup.heading.2.markdown'] = { bg = 'base', fg = 'gold' },
		...
		-- RenderMarkdownH1Bg = { bg = 'love', fg = 'love' },
		-- RenderMarkdownH2Bg = { bg = 'gold', fg = 'gold' },
		-- RenderMarkdownH3Bg = { bg = 'rose', fg = 'rose' },
		-- RenderMarkdownH4Bg = { bg = 'iris', fg = 'iris' },
		-- RenderMarkdownH5Bg = { bg = 'foam', fg = 'foam' },
